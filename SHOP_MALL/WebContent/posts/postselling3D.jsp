...
<link rel="stylesheet" href="../css/postsellinglist.css">
    ...
    <li class="on" style="width:140px"><a href="postselling3D.jsp" onclick="loading('1');">버추얼 3D</a></li>
</ul>
    ...
    <div class="list_img_box both left">
        <ul>    
            <ol style="height: 145px;">
                <a href="../posts/postselling.jsp" target="_blank">
                    <img src="../postimages/123.png" alt="상품 이미지" style="width: 100%; height: auto;">
                </a>
            </ol>    
            <ol style="height: 28px;">    
                <dl class="left ellip" style="padding-left:6px; width:360px;">
                    YSJIN4 작가&nbsp;&nbsp;/&nbsp;&nbsp;버튜버제작 / 버추얼3D
                </dl>        
                <dl class="right" style="margin-top:-6px;">
                    <a onclick="wishListAdd('43813')">
                        <img src="../postimages/heart.png" id="wish43813" title="관심 작가">
                    </a>
                </dl>
            </ol>    
            <ol>
	...
	<!-- 오른쪽 본문 부분 -->
	<div id="list_img">
    <div class="list_img_box both right">
        <ul>    
            <ol style="height: 145px;">
                <a href="../posts/postselling.jsp" target="_blank">
                    <img src="../postimages/123.png" alt="상품 이미지" style="width: 100%; height: auto;">
