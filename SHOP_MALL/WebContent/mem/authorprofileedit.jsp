...
<div class="wrapBody">
	...
	<form name="my" action="/admin/updateProfile.do" method="post" enctype="multipart/form-data" onsubmit="return check()">
		...
		<div class="form-group">
			<label>작가 이름</label> <input type="text" name="authorname"
				value="${author.authorname}" required>
		</div>
		...
		<div class="form-group">
			<label>프로필 이미지1</label> <input type="file" name="authorimg1"
				accept="image/*">
		</div>

		<div class="form-group">
			<label>프로필 이미지2</label> <input type="file" name="authorimg2"
				accept="image/*">
		</div>

		<div class="form-group">
			<label>프로필 이미지3</label> <input type="file" name="authorimg3"
				accept="image/*">
		</div>
