	...
	public void doCommand(HttpServletRequest request, HttpServletResponse response)
		 ...
		 request.setCharacterEncoding("utf-8");
	        ...
	        if(sessionUser == null) {
	            ...
	            request.getRequestDispatcher("/mem/UpdateCurrentPassword.jsp").forward(request, response);
	            return;
	        }
	        ...
	        response.sendRedirect(request.getContextPath() + "/member/updateNewPassword.do");
	    }
